# -*- coding: utf-8 -*-
{
    ...
    "summary": """
     Auto-e-mail on PLM ECO Stage
       """,
    "description": """
        Auto-e-mail on PLM ECO Stage.The system generates an e-mail to be
        sent to all these unique approvers using the e-mail template
        specified in the "E-mail Template" field on the ECO Stage.
    """,
